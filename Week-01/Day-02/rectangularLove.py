...
def find_rectangular_overlap(rect1, rect2):
    ...
    start_x, overlapWidth  = find_range_overlap(rect1['left_x'], rect1['width'], rect2['left_x'], rect2['width'])
    start_y, overlapHeight = find_range_overlap(rect1['bottom_y'], rect1['height'], rect2['bottom_y'], rect2['height'])
    ...
    return {
        'left_x': start_x, 'bottom_y': start_y, 'width': overlapWidth, 'height': overlapHeight,
    }
